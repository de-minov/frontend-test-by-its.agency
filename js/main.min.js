(function () {
  ...
  function getParams(element, propName, propValue) {
    ...
    attrsList.forEach(attr => {
      ...
      if (moduleParam) {
        ...
        if (passedParams[name] && modulesParamsList.includes(attr.name) && !isObject$2(value)) {
  ...
  function Banner() {
    ...
    if (!banner) return;
    var slider = banner.querySelector('.swiper');
    if (!slider) return;
    var navigationPrev = slider.querySelector('.banner__navigation--prev');
    var navigationNext = slider.querySelector('.banner__navigation--next');
  ...
  function isEmpty(value) {
    ...
    if (isArrayLike(value) &&
        (isArray$2(value) || typeof value == 'string' || typeof value.splice == 'function' ||
          isBuffer$2(value) || isTypedArray$1(value) || isArguments(value))) {
      return !value.length;
    }
  ...
  var BasketStorage = /*#__PURE__*/function () {
    function BasketStorage(_ref) {
      var onBasketUpdate = _ref.onBasketUpdate,
        onProductCountChange = _ref.onProductCountChange,
        onTotalPriceChange = _ref.onTotalPriceChange,
        onRenderBasket = _ref.onRenderBasket;
      _classCallCheck(this, BasketStorage);
      this.products = []; // Список товаров в корзине (productID + quantity)
      this._products = []; // Храним все товары, полученные из API
      this._onBasketUpdate = onBasketUpdate || function () {};
      this._onProductCountChange = onProductCountChange || function () {};
      this._onTotalPriceChange = onTotalPriceChange || function () {};
      this._onRenderBasket = onRenderBasket || function () {};
    }

    // Метод для получения всех товаров
    return _createClass(BasketStorage, [{
      key: "getProducts",
      value: function () {
        var _getProducts = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.p = _context.n) {
              case 0:
                _context.p = 0;
                _context.n = 1;
                return axios.get('./files/api/products.json');
              case 1:
                response = _context.v;
                // Пример запроса
                data = response.data;
                if (isArray$2(data) && !isEmpty(data)) {
      ...
      key: "addProduct",
      value: function () {
        var _addProduct = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(productID) {
          var quantity,
            product,
            existingProduct,
            _args2 = arguments;
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              ...
              case 1:
                ...
                product = find(this._products, function (product) {
              ...
              case 2:
                ...
                existingProduct = find(this.products, function (product) {
      ...
      value: function removeProduct(productID) {
        this.products = filter(this.products, function (product) {
          return product.productID != productID;
        });
        this.updateBasket();
      }
      ...
      key: "replaceProduct",
      value: function replaceProduct(oldProductID, newProductID) {
      ...
      value: function updateProductQuantity(productID, quantity) {
        var product = find(this.products, function (product) {
          return product.productID == productID;
        });
        if (product) {
          if (isNaN$1(quantity)) {
      ...
      value: function updateBasket() {
        ...
        var totalQuantity = sumBy(this.products, 'quantity');
      ...
      value: function calculateTotalPrice() {
        var _this = this;
        return sumBy(this.products, function (_ref2) {
          var productID = _ref2.productID,
            quantity = _ref2.quantity;
          var product = find(_this._products, function (product) {
            return product.id == productID;
          }); // Ищем продукт в _products
      ...
      key: "getProductsDetails",
      value: function getProductsDetails() {
        var _this2 = this;
        return compact(map(this.products, function (_ref3) {
          var productID = _ref3.productID,
            quantity = _ref3.quantity;
          var product = find(_this2._products, function (product) {
            return product.id == productID;
          });
          return product ? _objectSpread2(_objectSpread2({}, product), {}, {
            quantity: quantity
          }) : null;
        }));
      }
  ...
  var decOfNum = function decOfNum(n, titles) {
    return titles[n % 10 == 1 && n % 100 != 11 ? 0 : n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 10 || n % 100 >= 20) ? 1 : 2];
  };

  var pageDisableScroll = function pageDisableScroll() {
    var html = document.documentElement;
    var body = document.body;
    var gutter = window.innerWidth - body.clientWidth;
    var mql = window.matchMedia('screen and (max-width: 2560px)').matches;
    if (gutter > 0) {
      if (mql) {
    ...
    var event = new CustomEvent('page-disable-scroll', {
      detail: {
        gutter: gutter
      }
    });
  ...
  var pageEnableScroll = function pageEnableScroll() {
    var html = document.documentElement;
    var body = document.body;
    body.style.setProperty('--scrolling-gutter', '');
    body.style.setProperty('--scrolling-gutter-body', '');
    delete html.dataset.noScroll;
    var event = new CustomEvent('page-enable-scroll');
    window.dispatchEvent(event);
  };
  var pageToggleScroll = function pageToggleScroll() {
    !document.documentElement.dataset.noScroll ? pageDisableScroll() : pageEnableScroll();
  };

  function BasketContent() {
    var parent = document.querySelector('.basket');
    if (!parent) return;
    var basketList = parent.querySelector('.basket-product__list');
    var productCount = parent.querySelector('.basket-product__head-value');
    var totalPrice = parent.querySelector('.basket__price-value');
    var template = parent.querySelector('template#basket-card--template');
    var counters = document.querySelectorAll('[data-basket-value]');
    var clearBasketButton = parent.querySelector('.basket-product__head-clear');
    var submitButton = parent.querySelector('.basket__submit');
    if (!template) {
    ...
    var renderBasketCard = function renderBasketCard(product) {
      var node = template.content.cloneNode(true);
      var parent = node.querySelector('.basket-card');
      var img = node.querySelector('.basket-card__image img');
      var title = node.querySelector('.basket-card__info-title');
      var price = node.querySelector('.basket-card__info-price');
      var quantityInput = node.querySelector('input[name="basket-product"]');
      var quantityInputLabel = node.querySelector('.input-score__value');
      var removeButton = node.querySelector('[data-action="remove"]');
      var replaceButton = node.querySelector('[data-action="replace"]');
      parent.dataset.productId = product.id;
      parent.dataset.status = join(compact([product.isNew ? 'isNew' : '', product.inStock ? 'inStock' : '', product.isContract ? 'isContract' : '', product.isExclusive ? 'isExclusive' : '', product.isSale ? 'isSale' : '']), ' ');
      ...
      quantityInput.addEventListener('change', function (event) {
        requestAnimationFrame(function () {
          var newQuantity = toNumber(event.target.getAttribute('value')); // Получаем новое количество
    ...
    var updateBasketUI = function updateBasketUI() {
      var products = basketStorage.getProductsDetails();
      basketList.innerHTML = ''; // Очищаем старый список

      if (isArray$2(products) && products.length) {
        forEach$1(products, function (product) {
      ...
      if (submitButton) {
        var canSubmit = some(products, ['inStock', true]);
        if (!canSubmit) {
    ...
    var basketStorage = new BasketStorage({
      onBasketUpdate: function onBasketUpdate() {
        updateBasketUI();
      },
      onProductCountChange: function onProductCountChange(count) {
        productCount.textContent = "".concat(count, " ").concat(decOfNum(count, ['товар', 'товара', 'товаров']));
        if (!isEmpty(counters)) {
          forEach$1(_toConsumableArray(counters), function (item) {
            item.dataset.basketValue = count;
          });
        }
      },
      onTotalPriceChange: function onTotalPriceChange(total) {
    ...
    var closeBasketHandler = function closeBasketHandler() {
      if (parent.classList.contains('basket--opened')) {
        parent.classList.remove('basket--opened');
        pageEnableScroll();
      }
    };
    var openBasketHandler = function openBasketHandler() {
    ...
    document.addEventListener('click', function (event) {
      ...
      var openBasket = event.target.closest('.basket-action--opened');
      if (openBasket) {
        openBasketHandler();
      }
      var closeBasket = event.target.closest('.basket-action--closed');
      if (closeBasket) {
        closeBasketHandler();
      }
    });
  ...
  function InputScore() {
    document.addEventListener('click', function (event) {
      var target = event.target.closest('.input-score__button');
      if (!target) return;
      var parent = target.closest('.input-score');
      var input = parent.querySelector('.input-score__input-hidden');
      var display = parent.querySelector('.input-score__value');
      if (!input || !display) return;
      var step = toNumber(input.dataset.step) || 1;
      var minAttr = input.dataset.min;
      var maxAttr = input.dataset.max;
      var hasMin = isFinite$1(toNumber(minAttr));
      var hasMax = isFinite$1(toNumber(maxAttr));
      var min = hasMin ? toNumber(minAttr) : null;
      var max = hasMax ? toNumber(maxAttr) : null;
      var isClear = input.dataset.isClear !== undefined;
      var isStart = input.dataset.isStart !== undefined;
      ...
      if (input.disabled && rawValue === 'deleted') {
        ...
        var parsed = toNumber(rawValue);
        currentValue = isFinite$1(parsed) ? parsed : 0;
      }
      ...
      // Очистка
      if (isClear && hasMin && currentValue <= min && target.classList.contains('input-score__button--minus')) {
  ...
  function InputSelect() {
    document.addEventListener('click', function (event) {
      ...
      if (target.closest('.input-select__label')) {
        var parent = target.closest('.input-select');
        var input = parent.querySelector('.input-select__input-hidden');
        var drop = parent.querySelector('.input-select__drop');
        if (!input || !drop) return;
        var isOpen = drop.classList.toggle('input-select__drop--dropped');
        if (isOpen) {
          pageToggleScroll();
      ...
      if (target.closest('.input-select__drop-item')) {
        var _parent = target.closest('.input-select');
        var _input = _parent.querySelector('.input-select__input-hidden');
        var _drop = _parent.querySelector('.input-select__drop');
        var label = _parent.querySelector('.input-select__label');
        var labelText = label.querySelector('span');
        if (!_input || !_drop || !labelText) return;
        var selectedItem = target.closest('.input-select__drop-item');
        if (!selectedItem) return;
        var oldActive = _drop.querySelector('.input-select__drop-item--selected');
        ...
        _input.value = selectedItem.dataset.value;
      ...
      function closeDrop() {
        var openDrop = document.querySelector('.input-select__drop--dropped');
        if (openDrop) {
      ...
      function handleClickOutside(e) {
        var parent = e.target.closest('.input-select');
  ...
  var ProductsStorage = /*#__PURE__*/function () {
    function ProductsStorage() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        onStatusChange = _ref.onStatusChange,
        onProductCountChange = _ref.onProductCountChange,
        onProductsUpdate = _ref.onProductsUpdate;
      _classCallCheck(this, ProductsStorage);
      this.status = 'init';
      this._products = [];
      this.products = [];
      ...
      this._onProductCountChange = onProductCountChange || function () {};
      this._onProductsUpdate = onProductsUpdate || function () {};
      this._updateStatus(this.status);
    }
    return _createClass(ProductsStorage, [{
      key: "_updateStatus",
      ...
      key: "_updateProducts",
      value: function _updateProducts(list) {
        this.products = list;
      ...
      key: "applyFiltersAndSort",
      value: function applyFiltersAndSort() {
        var _this = this;
        // 1. Фильтрация
        var result = filter(this._products, function (product) {
          return every(_this.activeFilters, function (val, key) {
            return product[key] === val;
          });
        });

        // 2. Сортировка
        var _split = (this.activeSort || '').split('_'),
          _split2 = _slicedToArray(_split, 2),
          field = _split2[0],
          _split2$ = _split2[1],
          dir = _split2$ === void 0 ? 'asc' : _split2$;
        if (field) {
          var fieldName = field;
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.p = _context.n) {
              ...
              case 4:
                _context.p = 4;
                _t = _context.v;
                console.error('Ошибка загрузки товаров:', _t);
  ...
  function ProductsContent() {
    ...
    if (!parent) return;
    var grid = parent.querySelector('.products__grid');
    var values = parent.querySelector('.products__head-values');
    var template = parent.querySelector('template#product-card--template');
    var aside = parent.querySelector('.products__aside');
    var filtersBlock = parent.querySelector('.products__filter');
    if (!template) {
      console.error('Template for product card is not found. ' + 'Please, check if you have added template for product card.');
      return;
    }
    var renderProductCard = function renderProductCard(product) {
      var _window$basketStorage;
      var node = template.content.cloneNode(true);
      var parent = node.querySelector('.product-card');
      var img = node.querySelector('.product-card__image img');
      var title = node.querySelector('.product-card__title');
      var price = node.querySelector('.product-card__footer-price');
      var quantityParent = node.querySelector('.input-score');
      var quantityInput = quantityParent.querySelector('input[name="product-item"]');
      var quantityInputLabel = quantityParent.querySelector('.input-score__value');
      parent.dataset.productId = product.id;
      parent.dataset.status = join(compact([product.isNew ? 'isNew' : '', product.inStock ? 'inStock' : '', product.isContract ? 'isContract' : '', product.isExclusive ? 'isExclusive' : '', product.isSale ? 'isSale' : '']), ' ');
      img.src = product.image || './files/images/no-photo.jpg';
      img.alt = product.title || 'product';
      ...
      var existingProduct = find((_window$basketStorage = window.basketStorage) === null || _window$basketStorage === void 0 ? void 0 : _window$basketStorage.products, function (p) {
        return p.productID == product.id;
      });
      var quantity = (existingProduct === null || existingProduct === void 0 ? void 0 : existingProduct.quantity) || 0;
      ...
      quantityInput.addEventListener('change', function (event) {
        var newQuantity = toNumber(event.target.getAttribute('value'));
        if (!window.basketStorage) return;
        var existing = find(window.basketStorage.products, function (p) {
          return p.productID == product.id;
        });
        var prevQuantity = (existing === null || existing === void 0 ? void 0 : existing.quantity) || 0;
    ...
    var productsStorage = new ProductsStorage({
      onStatusChange: function onStatusChange(status) {
        parent.dataset.status = status;
      },
      onProductCountChange: function onProductCountChange(count) {
        if (values) {
          values.textContent = "".concat(count, " ").concat(decOfNum(count, ['товар', 'товара', 'товаров']));
        }
      },
      onProductsUpdate: function onProductsUpdate(products) {
        if (!isArray$2(products)) return;
        grid.innerHTML = '';
        forEach$1(products, function (product) {
    ...
    var readFilters = function readFilters() {
      var inputs = filtersBlock.querySelectorAll('input[type="checkbox"]:checked');
      if (!inputs.length) return;
      var pairs = map(_toConsumableArray(inputs), function (input) {
    ...
    var sortingInput = parent.querySelector('input[name="product_sort"]');
    sortingInput === null || sortingInput === void 0 || sortingInput.addEventListener('change', function () {
      var sortValue = sortingInput.value;
      productsStorage.setSort(sortValue);
    });
    window.productsStorage = productsStorage;
    productsStorage.setFilters(readFilters());
    productsStorage.setSort((sortingInput === null || sortingInput === void 0 ? void 0 : sortingInput.value) || '');
    productsStorage.getProducts();
    window.addEventListener('basket:updated', function (event) {
      var updated = event.detail.products;
      var cards = parent.querySelectorAll('.product-card');
      if (isEmpty(cards)) return;
      forEach$1(_toConsumableArray(cards), function (card) {
        var productID = card.dataset.productId;
        var quantityInput = card.querySelector('input[name="product-item"]');
        var quantityLabel = card.querySelector('.input-score__value');
        var quantityParent = card.querySelector('.input-score');
        var match = find(updated, function (p) {
          return p.productID == productID;
        });
        var quantity = (match === null || match === void 0 ? void 0 : match.quantity) || 0;
    ...
    var filterButton = parent.querySelector('.products__head-filter');
    var asideShowHandler = function asideShowHandler() {
      if (!aside) return;
      aside.classList.add('products__aside--dropped');
      pageDisableScroll();
    };
    var asideHideHandler = function asideHideHandler() {
    ...
    if (aside) {
      window.addEventListener('breakpoint:change', function (event) {
        var isMobile = event.detail.isMobile;
        if (!isMobile && aside.classList.contains('products__aside--dropped')) {
          aside.classList.remove('products__aside--dropped');
        }
      });
      window.addEventListener('click', function (event) {
        var _window$breakpointObs;
        var isMobile = (_window$breakpointObs = window.breakpointObserver) === null || _window$breakpointObs === void 0 ? void 0 : _window$breakpointObs.isMobile;
        var isAsideOpen = aside.classList.contains('products__aside--dropped');
        if (!isMobile || !isAsideOpen) return;
        var clickInsideAside = aside.contains(event.target);
        var clickOnFilterButton = filterButton === null || filterButton === void 0 ? void 0 : filterButton.contains(event.target);
  ...
  var BreakpointObserver = /*#__PURE__*/function () {
    function BreakpointObserver() {
      ...
      _defineProperty(this, "isMobile", undefined);
      _defineProperty(this, "isDesktop", undefined);
      _classPrivateFieldInitSpec(this, _mediaQuery, window.matchMedia('screen and (max-width: 768px) and (max-height: 1023px) and (orientation: portrait)'));
      this._handleChange = this._handleChange.bind(this);
      _classPrivateFieldGet2(_mediaQuery, this).addEventListener('change', this._handleChange);
      this._handleChange(_classPrivateFieldGet2(_mediaQuery, this)); // initial trigger
    }
    return _createClass(BreakpointObserver, [{
      key: "_handleChange",
      value: function _handleChange(e) {
        this.isMobile = e.matches;
        this.isDesktop = !e.matches;
        var event = new CustomEvent('breakpoint:change', {
          detail: {
      ...
      value: function destroy() {
        _classPrivateFieldGet2(_mediaQuery, this).removeEventListener('change', this._handleChange);
      }
    }]);
  }();
